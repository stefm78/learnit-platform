...
def profile_contract():
 ...
 default=parse_args(base); explicit=parse_args(base+["--runtime-profile",GATE2_PILOT_READ_ONLY])
 return {"max_runtime_jobs":explicit.max_jobs,"gate3":"HOLD","gate4":"HOLD","full_v6":False,"explicit_opt_in":explicit.runtime_profile==GATE2_PILOT_READ_ONLY,"default_gate1_unchanged":default.runtime_profile!=GATE2_PILOT_READ_ONLY}
