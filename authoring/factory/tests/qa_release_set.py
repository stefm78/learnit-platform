#!/usr/bin/env python3
"""Independent contradictory QA oracle for QA-WP-024 / Atlas M3.4 release sets.

Authority: issue #328.
Frozen product HEAD: 41f2245e56b42a2e541d185f39a3edb5d8b6f01b.
...
EXPECTED_PRODUCT_HEAD = "41f2245e56b42a2e541d185f39a3edb5d8b6f01b"
...
def make_kit(index: int, *, title: str | None = None) -> dict:
    ...
    kit = _remap_uuids(copy.deepcopy(base), f"qa-wp-024-{index}", {})
    ...
    def test_03_forged_pass_must_not_override_embedded_semantic_hold(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(
                ...
                msg=(
                    "QA-WP-024 attack #3: release_set accepted a forged PASS whose "
    ...
    def test_10_manifest_representation_tamper_must_fail_closed(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with self.assertRaises(
                release_set.ReleaseSetInputError,
                msg=(
                    "QA-WP-024 attack #25/#30: verifier accepted noncanonical "
