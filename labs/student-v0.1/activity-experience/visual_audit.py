...
for n in ['lab_core.js','lab_baselines.js','lab_v6_helpers.js','lab_v6_flash.js','lab_v6_matching.js','lab_v7_order.js','lab_v6_classify.js','lab_v6_fill.js','lab_bootstrap.js']:html=html.replace(f'<script src="{n}"></script>','')
css=(ROOT/'styles.css').read_text();scripts=[(ROOT/n).read_text() for n in ['lab_core.js','lab_baselines.js','lab_v6_helpers.js','lab_v6_flash.js','lab_v6_matching.js','lab_v7_order.js','lab_v6_classify.js','lab_v6_fill.js','lab_bootstrap.js']]
def page(ctx):
...
print('VISUAL_AUDIT_CAPTURE_V7: PASS')
