...
""")
    ...
    def test_previous_feedback_is_consumed_before_next_question(self):
        source = SESSION.read_text(encoding="utf-8")
        self.assertIn("showFeedbackTransition(", source)
        self.assertIn("data-atlas-feedback-transition", source)
        self.assertIn("Activité suivante", source)
