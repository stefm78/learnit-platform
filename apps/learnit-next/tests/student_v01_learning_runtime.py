...
for(const data of [
  ...
  '<svg xmlns="http://www.w3.org/2000/svg"><image href=/external.png /></svg>',
  '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"><use xlink:href=/external.svg#x /></svg>',
  '<svg xmlns="http://www.w3.org/2000/svg" xml:base="/external/"><use href="#p"/></svg>',
